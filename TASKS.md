...
- [x] **P1-Q1** `[QUERY]` Implement `src/schema_linker.py` â€” `SchemaContext`, `FieldMeta` dataclasses; `SchemaLinker` class that:
...
- [x] **P1-Q2** `[QUERY]` Implement `src/executor.py` â€” `ElasticsearchExecutor`:
...
- [x] **P1-R2** `[RAG]` Implement `src/preprocessor.py` â€” `Preprocessor` class:
...
- [x] **P2-Q1** `[QUERY]` Implement `src/few_shot.py` â€” `FewShotSelector`:
...
- [x] **P2-Q2** `[QUERY]` Implement `src/generator.py` â€” `KQLGenerator`:
...
- [x] **P2-Q3** `[QUERY]` Implement `src/validator.py` â€” `KQLValidator` (recursive-descent parser):
...
- [x] **P2-Q4** `[QUERY]` Implement `src/repair.py` â€” `RepairAgent`:
...
- [x] **P2-Q5** `[QUERY]` Implement `src/pii.py` â€” `PIIMasker`:
...
- [x] **P2-R1** `[RAG]` Implement `src/temporal.py` â€” `TemporalFilter`:
...
- [x] **P2-R2** `[RAG]` Implement `src/dense.py` â€” `DenseRetriever`:
...
- [x] **P2-R3** `[RAG]` Implement `src/sparse.py` â€” `SparseRetriever`:
...
- [x] **P2-R4** `[RAG]` Implement `src/fusion.py` â€” `WRRFFusion`:
...
- [x] **P2-R5** `[RAG]` Implement `src/reranker.py` â€” `CrossEncoderReranker`:
...
- [ ] **P2-R7** `[RAG]` Wire `POST /knowledge` endpoint (no conflict detection yet):
  ...
  - Integration test: POST with semantic query returns `KnowledgeResult` with â‰¥ 1 chunk from seeded docs
...
- [x] **P3-M2** `[MASTER]` Implement `src/intent.py` â€” `IntentClassifier`:
  ...
  - Unit tests: "count HTTP 500s" â†’ `is_quantitative=True, logs_needed=True, docs_needed=False`; "best practice for node sizing" â†’ `logs_needed=False, docs_needed=True`; 40-query fixture set â‰¥ 95 % accuracy
...
- [x] **P3-M6** `[MASTER]` Implement `src/reasoner.py` â€” `ReasonerAgent` (Tree of Thoughts):
...
- [x] **P3-M7** `[MASTER]` Implement `src/validator.py` â€” `ValidatorAgent`:
...
- [x] **P5-1** `[QUERY]` Build evaluation harness for NL-to-KQL:
